...
public class SetOutputThenAddObserver implements Command<Model> {
	/**
	 * 
	 */
	...
	public SetOutputThenAddObserver(Location liveModelLocation, Location outputLocation, Location observableLocation, Location observerLocation) {
	...
	public void executeOn(PropogationContext propCtx,
			Model prevalentSystem, Date executionTime, PrevaylerServiceConnection<Model> connection, PrevaylerServiceBranch<Model> branch) {
