...
public class ForwardLocalChangesUpwardsCommand implements MappableCommand<Model> {
	/**
	 * 
	 */
	...
	public ForwardLocalChangesUpwardsCommand(Location locationOfSource) {
	...
	public Command<Model> mapToReferenceLocation(Model sourceReference, Model targetReference) {
		...
		return new ForwardLocalChangesUpwardsCommand(locationOfSourceFromTargetReference);
	}
}
