...
//		@Override
//		public TransactionFactory getMetaTransactionFactory() {
//			return transactionFactory.extend(new Model.MetaModelLocator());
//		}
...
//			return view.getDefaultDropTransaction(dropped, dropPoint);
			return null;
		}
