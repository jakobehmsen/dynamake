...
//						selectionFrame.setBorder(BorderFactory.createLineBorder(Color.BLACK, 4));
						...
						MouseAdapter mouseAdapter = new MouseAdapter() {
							...
							public void mouseMoved(MouseEvent e) {
								switch(productionPanel.livePanel.model.state) {
							...
							private void mouseMovedEdit(MouseEvent e) {
								if(selection != productionPanel.contentView.getBindingTarget()) {
									Point point = e.getPoint();
									
									updateRelativeCursorPosition(point, productionPanel.effectFrame.getSize());
							...
							private void mouseReleasedEdit(MouseEvent e) {
								if(e.getButton() == MouseEvent.BUTTON1 && selection != productionPanel.contentView.getBindingTarget()) {
							...
							private void mouseReleasedDrag(MouseEvent e) {
								if(e.getButton() == MouseEvent.BUTTON1) {
									...
									if(targetModelComponent != null && selection != targetModelComponent) {
										showPopupForSelectionObject(productionPanel.selectionFrame, e.getPoint(), targetModelComponent);
									} else {
										showPopupForSelectionObject(productionPanel.selectionFrame, e.getPoint(), null);
									}
							...
							private void mouseDraggedEdit(MouseEvent e) {
								if(selectionMouseDown != null && effectFrameMoving && selection != productionPanel.contentView.getBindingTarget()) {
							...
							private void mouseDraggedPlot(MouseEvent e) {
								if(selectionMouseDown != null) {
									...
									Rectangle plotBoundsInProductionPanel = SwingUtilities.convertRectangle((JComponent)selection, plotBoundsInSelection, productionPanel);
		...
		private Binding<ModelComponent> contentView;
		private EditPanelMouseAdapter editPanelMouseAdapter;
...
//						
//						// final ModelComponent view, final Point initialMouseDown, boolean moving, Rectangle effectBounds
//						livePanel.getTransactionFactory().executeOnRoot(new SetSelection(livePanel.getTransactionFactory().getLocation(), view.getTransactionFactory().getLocation()));
//						livePanel.getTransactionFactory().execute(new Model.SetPropertyTransaction("SelectionInitialMouseDown", initialMouseDown));
//						livePanel.getTransactionFactory().execute(new Model.SetPropertyTransaction("SelectionMoving", moving));
//						livePanel.getTransactionFactory().execute(new Model.SetPropertyTransaction("SelectionEffectBounds", effectBounds));
//					} else {
//						if(effectFrame != null) {
//							clearFocus();
//						}
