...
public class Unwrap2Transaction implements Command<Model> {
	/**
	 * 
	 */
	...
	public Unwrap2Transaction(Location targetLocation, Location wrapperLocationInTarget, int[] modelIndexes, Rectangle creationBounds) {
